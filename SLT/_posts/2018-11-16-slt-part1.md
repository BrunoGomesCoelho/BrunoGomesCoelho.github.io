...
I would suggest first having a look at the [explanation behind the K Nearest Neighbours (K-NN)]({% post_url ML4u/2018-11-17-ml4u-video5_6_7 %}) algorithm, which accompanies a implementation in Python3.

If you already have the idea behing K-NN at the tip of your tongue, go ahead and read on [about the proof that it is a consistent algorithm]({% post_url SLT/2018-11-16-slt-part2 %}).
